...
class UserStartedImpersonating extends AggregateChanged
{
    private UserId $adminUserId;
    private UserId $impersonatedUserId;
    private Email $impersonatedEmail;
    ...
    public static function now(
        ...
        $event->impersonatedEmail = $impersonatedEmail;
    ...
    public function impersonatedEmail(): Email
    {
        if (!isset($this->impersonatedEmail)) {
            $this->impersonatedEmail = Email::fromString($this->payload['impersonatedEmail']);
        }
