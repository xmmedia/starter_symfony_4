...
return static function (RectorConfig $config): void {
    ...
    $config->import(SymfonySetList::SYMFONY_63);
    ...
    $config->rule(RectorRules\ClassMethod\AddVoidReturnTypeWhereNoReturnRector::class);
    ...
    // $config->singleton(ServiceType::class)
    // $config->services();
};
